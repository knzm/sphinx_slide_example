# -*- coding: utf-8 -*-
#
# sphinx_slide_example documentation build configuration file, created by
# sphinx-quickstart on Thu Aug 16 23:22:14 2012.
#
...
project = u'sphinx_slide_example'
copyright = u'2012, anonymous'
...
latex_documents = [
  ('index', 'sphinx_slide_example.tex', u'sphinx\\_slide\\_example Documentation',
   u'anonymous', 'manual'),
]
...
man_pages = [
    ('index', 'sphinx_slide_example', u'sphinx_slide_example Documentation',
     [u'anonymous'], 1)
]
...
texinfo_documents = [
  ('index', 'sphinx_slide_example', u'sphinx_slide_example Documentation',
   u'anonymous', 'sphinx_slide_example', 'One line description of project.',
   'Miscellaneous'),
]
